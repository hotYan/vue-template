...
export default {
  ...
  data() {
    return {
      ...
      sliderArr: [
        { left: 'zoomDown1', method: this.changeZoom, model: 50, right: 'zoomUp1', show: true },
        { left: 'volumeDown', method: this.changeRound, model: 50, right: 'volumeUp', show: this.showRound }
      ],
      playArr: [
      ...
      _this.$nextTick(() => {
        ...
        _this.wavesurfer.on('waveform-ready', () => {
          ...
          if (status === 1) { // 已标注
            ...
            // _this.$emit('getRegionList', _this.regionList)
          }
          _this.loading = false

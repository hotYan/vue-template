    ...
    initAudio(status = 0, url = '', data = []) {
      ...
      _this.$nextTick(() => {
        ...
        _this.wavesurfer.on('ready', () => {
          ...
          console.log('_this.wavesurfer', _this.wavesurfer)
          console.log('_this.wavesurfer.drawer', _this.wavesurfer.drawer)
          console.log('_this.wavesurfer.drawer.canvases[0]', _this.wavesurfer.drawer.canvases[0])
